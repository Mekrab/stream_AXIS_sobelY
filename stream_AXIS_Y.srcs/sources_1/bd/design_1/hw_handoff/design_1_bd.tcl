...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_ACT_DCI_PERIPHERAL_FREQMHZ {10.200000} \
   ...
   CONFIG.PCW_ARMPLL_CTRL_FBDIV {22} \
   ...
   CONFIG.PCW_CRYSTAL_PERIPHERAL_FREQMHZ {60} \
   CONFIG.PCW_DCI_PERIPHERAL_DIVISOR0 {50} \
   CONFIG.PCW_DCI_PERIPHERAL_DIVISOR1 {2} \
   CONFIG.PCW_DDRPLL_CTRL_FBDIV {17} \
   CONFIG.PCW_DDR_DDR_PLL_FREQMHZ {1020.000} \
   ...
   CONFIG.PCW_UIPARAM_ACT_DDR_FREQ_MHZ {510.000000} \
  ...
  set stream_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:stream:1.0 stream_0 ]

  # Create interface connections
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins stream_0/S00_AXIS]
  ...
  connect_bd_intf_net -intf_net stream_0_M00_AXIS [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins stream_0/M00_AXIS]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk] [get_bd_pins stream_0/m00_axis_aclk] [get_bd_pins stream_0/s00_axis_aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn] [get_bd_pins stream_0/m00_axis_aresetn] [get_bd_pins stream_0/s00_axis_aresetn]
